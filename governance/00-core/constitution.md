...
This constitution defines the **foundational principles** that govern all development within the brAInwav Cortex-OS ecosystem. It complements and extends the consolidated `AGENT_CHARTER.md` (Rules of AI) and `CODESTYLE.md` with project-specific governance for feature development, agent behavior, and quality standards. It is part of the **Governance Pack** (`/.cortex/rules/*`) and is **binding** on all repositories in the org.
...
`/.cortex/rules/agentic-phase-policy.md` (v2025.11) and `/.cortex/rules/agentic-coding-workflow.md`.
