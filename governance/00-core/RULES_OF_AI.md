...
alwaysApply: true
---
# brAInwav Cortex-OS: Rules of AI → AGENT_CHARTER.md

**Status**: CONSOLIDATED (stub only; not in governance precedence) - Content moved to canonical location
**New Location**: `/.cortex/rules/00-core/AGENT_CHARTER.md` § AI Behavioral Rules  
...
👉 **See**: `/.cortex/rules/00-core/AGENT_CHARTER.md` § "AI BEHAVIORAL RULES"
...
- **[Agentic Coding Workflow](/.cortex/rules/10-flow/agentic-coding-workflow.md)**
- **[Cortex-Aegis](/.cortex/rules/10-flow/cortex-aegis.md)**
- **[Task Folder Structure](/.cortex/rules/10-flow/TASK_FOLDER_STRUCTURE.md)**
- **[Code Review Checklist](/.cortex/rules/20-checklists/code-review-checklist.md)**
- **[CI Review Checklist](/.cortex/rules/20-checklists/CHECKLIST.cortex-os.md)**
