# Cortex-OS AI-Native Governance Quickstart
...
**What this is**: The operational "how we work with agents" guide for Cortex-OS development. This document provides the essential workflow patterns, gate policies, and responsibilities for AI-native software development.

**Who it is for**:

- Human engineers, reviewers, and maintainers working on Cortex-OS
...
- **Cortex-Aegis integration**: Assurance system validates plans and changes against governance
...
## 6. Cortex-Aegis in the Loop

**What Cortex-Aegis is**: Assurance system for agentic workflows that validates plans and changes against governance, security, and compliance requirements.
...
- [Unified Checklists](../20-checklists/checklists.cortex-os.md)
...
- [Cortex-Aegis](../10-flow/cortex-aegis.md) - Assurance system documentation
- [Time Freshness Policy](../10-flow/cortex-aegis.md#time-freshness-policy) - Time-sensitive validation rules

### Checklists & Quality

- [Unified Checklists](../20-checklists/checklists.cortex-os.md) - All quality gates and validation criteria
