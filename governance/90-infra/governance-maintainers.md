...
**Note:** `/.cortex/rules/90-infra/GOVERNANCE_HASH_UPDATE.md` is retained only as a stub pointer back to this guide for compatibility.
...
This document consolidates all governance infrastructure maintenance procedures, file purposes, and update workflows for `.cortex/rules/` governance system.
...
1. **`.cortex/rules/governance-index.json`** - Recomputes SHA-256 for all documents listed
...
- ✅ Editing any file in `.cortex/rules/`
...
- **Main Documentation**: `/.cortex/rules/10-flow/governance-quickstart.md`
