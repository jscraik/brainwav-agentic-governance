...
```
# React Native (canonical reference)

This file is a stub. Use `../react-native.md` for the maintained React Native guidance. Kept to preserve existing links while removing duplicate content.
---
