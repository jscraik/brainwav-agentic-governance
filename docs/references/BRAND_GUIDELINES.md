...
- [Overview](#overview)
- [Documentation Signature (Recommended)](#documentation-signature-recommended)
  - [Approved Text (Primary)](#approved-text-primary)
  - [Optional Text (Only when a descriptor is required)](#optional-text-only-when-a-descriptor-is-required)
  - [Rules](#rules)
  - [README Footer Snippet (WebP + Text)](#readme-footer-snippet-webp-text)
  - [ASCII Fallback (Non-Graphical Environments)](#ascii-fallback-non-graphical-environments)
- [Brand Guidelines](#brand-guidelines)
  - [Colors](#colors)
  - [Typography](#typography)
- [Features](#features)
  - [Smart Font Application](#smart-font-application)
  - [Text Styling](#text-styling)
  - [Shape and Accent Colors](#shape-and-accent-colors)
- [Visual Mark (WebP)](#visual-mark-webp)
...
- [Enforcement (Make docs consistent)](#enforcement-make-docs-consistent)
- [Recommended Repo Layout](#recommended-repo-layout)
- [Skill Asset Location](#skill-asset-location)
