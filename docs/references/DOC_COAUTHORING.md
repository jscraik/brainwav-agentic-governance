...
- [Stage 2: Refinement & Structure](#stage-2-refinement-structure)
  ...
  - [Step 3: Curation](#step-3-curation)
  - [Step 4: Gap Check](#step-4-gap-check)
  - [Step 5: Drafting](#step-5-drafting)
...
- [Stage 3: Reader Testing](#stage-3-reader-testing)
  ...
  - [Step 1: Predict Reader Questions](#step-1-predict-reader-questions)
  - [Step 2: Test with Sub-Agent](#step-2-test-with-sub-agent)
  - [Step 3: Run Additional Checks](#step-3-run-additional-checks)
  - [Step 4: Report and Fix](#step-4-report-and-fix)
  - [Step 1: Predict Reader Questions](#step-1-predict-reader-questions-2)
  - [Step 2: Setup Testing](#step-2-setup-testing)
  - [Step 3: Additional Checks](#step-3-additional-checks)
  - [Step 4: Iterate Based on Results](#step-4-iterate-based-on-results)
  - [Exit Condition (Both Approaches)](#exit-condition-both-approaches)
